...
def laser_callback(data):
    ...
    print('The distance to the rightmost(front) scanned point is: ', data.ranges[0])
    print('The distance to the leftmost(front) scanned point is: ', data.ranges[-1])
    print('The distance to the middle(behind) scanned point is: ', data.ranges[len(data.ranges)//2])
