...
void laser_callback(const sensor_msgs::LaserScan::ConstPtr& msg)
{
    ...
    std::cout<<"The distance to the rightmost(front) scanned point is "<<laser_ranges[0]<<std::endl;
    std::cout<<"The distance to the leftmost(front) scanned point is "<<laser_ranges[laser_ranges.size()-1]<<std::endl;
    std::cout<<"The distance to the middle(behind) scanned point is "<<laser_ranges[laser_ranges.size()/2]<<std::endl;
